...
class GetFriendListResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListResponse) */ {
 public:
  ...
  int friedn_list_size() const;
  void clear_friedn_list();
  static const int kFriednListFieldNumber = 2;
  ::fixbug::User* mutable_friedn_list(int index);
  ::google::protobuf::RepeatedPtrField< ::fixbug::User >*
      mutable_friedn_list();
  const ::fixbug::User& friedn_list(int index) const;
  ::fixbug::User* add_friedn_list();
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::fixbug::User > friedn_list_;
  ::fixbug::ResultCode* result_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_test_2eproto::TableStruct;
};
...
// repeated .fixbug.User friedn_list = 2;
inline int GetFriendListResponse::friedn_list_size() const {
  return friedn_list_.size();
}
inline void GetFriendListResponse::clear_friedn_list() {
  friedn_list_.Clear();
}
inline ::fixbug::User* GetFriendListResponse::mutable_friedn_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.friedn_list)
  return friedn_list_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::fixbug::User >*
GetFriendListResponse::mutable_friedn_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResponse.friedn_list)
  return &friedn_list_;
}
inline const ::fixbug::User& GetFriendListResponse::friedn_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.friedn_list)
  return friedn_list_.Get(index);
}
inline ::fixbug::User* GetFriendListResponse::add_friedn_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponse.friedn_list)
  return friedn_list_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::fixbug::User >&
GetFriendListResponse::friedn_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResponse.friedn_list)
  return friedn_list_;
}
